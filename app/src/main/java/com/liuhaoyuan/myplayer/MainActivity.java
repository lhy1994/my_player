...
import com.liuhaoyuan.myplayer.pager.BasePager;
import com.liuhaoyuan.myplayer.pager.LocalPager;
import com.liuhaoyuan.myplayer.pager.MusicPager;
import com.liuhaoyuan.myplayer.pager.VideoPager;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<BasePager> pagerList=new ArrayList<>();
        pagerList.add(new MusicPager(this));
        pagerList.add(new VideoPager(this));
        pagerList.add(new LocalPager(this));
    ...
    class MyPagerAdapter extends PagerAdapter{
        ...
        public MyPagerAdapter(ArrayList<BasePager> list){
            super();
            this.list=list;
        }
        @Override
